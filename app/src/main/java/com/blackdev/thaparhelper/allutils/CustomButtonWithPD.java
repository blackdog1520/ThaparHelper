...
public class CustomButtonWithPD extends AppCompatButton implements View.OnTouchListener {
...
//    }
    ...
    public CustomButtonWithPD(@NonNull Context context) {
        super(context);
        init();
    }

    public CustomButtonWithPD(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
        parseAttrs(context, attrs);
    }

    public CustomButtonWithPD(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
